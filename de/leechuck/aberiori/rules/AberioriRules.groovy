package de.leechuck.aberiori.rules;
...
public class AberioriRules {
   ...
   * Default constructor
   */
  public AberioriRules(String ontfile){
  ...
  public Rules runAlgorithm(Itemsets patterns, String output, int databaseSize)
  throws IOException {
  ...
  protected Set<Itemset> generateCandidateSizeK(Set<Itemset> levelK_1) {
	...
	if (missing != null) {
	  ...
	  Integer[] newItemset = new Integer[itemset1.size()+1];
	  
	  System.arraycopy((Integer[])itemset1.itemset, 0, newItemset, 0, itemset1.size());
